...
const dictionary = {
  en: {
    ...
    "adminLogin.subtitle": "BENCHIMIN ARCADE — Staff Dashboard",
    ...
    "account.editProfile": "✏️ Edit Profile",
    "account.saveChanges": "Save Changes",
    "account.cancelEdit": "Cancel",
    "account.nameLabel": "Display Name",
    "account.phoneLabel": "Phone Number",
    "account.phonePlaceholder": "e.g. 012 345 678",
    "account.changePhoto": "Change Photo",
    "account.removePhoto": "Remove",
    "account.uploadingPhoto": "Uploading…",
    "account.nameEmptyError": "Name can't be empty",
    "account.imageTooLargeError": "Image is too large (max 3MB)",
    "account.notAnImageError": "Please choose an image file",
    ...
    "welcomePopup.body":
      "Sign up now to play real-time games, climb the Leaderboard, and unlock Avatar Studio gear!",
    "welcomePopup.benefit1": "Earn points from missions & wins 💎",
    "welcomePopup.benefit2": "Rank up on the Leaderboard 🏆",
    ...
    "notif.loginPrompt": "Log in to get game invites and updates 💖",
    "notif.loginBtn": "Log In / Sign Up",
    "notif.empty": "No new notifications 🌈",
    "notif.promo": "🎁 Earn points from missions & game wins!",
    ...
    "missions.claimBtn": "Claim",
    "missions.claimed": "Claimed ✅",
    "missions.locked": "Not yet",
    "missions.claimSuccess": "Claimed! Points added 🎉",
    "missions.claimError": "Couldn't claim.",
    "missions.networkError": "Network error — please try again.",

    "shop.title": "Avatar Shop 🧢",
    "shop.buyBtn": "Buy",
    "shop.equipBtn": "Equip",
    "shop.unequipBtn": "Unequip",
    "shop.equippedBadge": "Equipped ✅",
    "shop.notEnough": "Not enough",
    "shop.buySuccess": "Purchased! 🎉",
    "shop.buyError": "Couldn't purchase.",
    "shop.networkError": "Network error — please try again.",
    "shop.categoryAll": "All",
    "shop.categoryHat": "Hats",
    ...
    "home.railGuestLoyaltyDesc": "Sign in to track Arcade Points, unlock tiers, and shop Avatar gear.",
  ...
  km: {
    ...
    "adminLogin.subtitle": "បេនជីមីន អាកែត — ផ្ទាំងគ្រប់គ្រងបុគ្គលិក",
    ...
    "account.editProfile": "✏️ កែប្រែប្រវត្តិរូប",
    "account.saveChanges": "រក្សាទុកការផ្លាស់ប្តូរ",
    "account.cancelEdit": "បោះបង់",
    "account.nameLabel": "ឈ្មោះសម្រាប់បង្ហាញ",
    "account.phoneLabel": "លេខទូរស័ព្ទ",
    "account.phonePlaceholder": "ឧ. ០១២ ៣៤៥ ៦៧៨",
    "account.changePhoto": "ប្តូររូបភាព",
    "account.removePhoto": "លុបរូបភាព",
    "account.uploadingPhoto": "កំពុងបញ្ចូល...",
    "account.nameEmptyError": "ឈ្មោះមិនអាចទទេបានទេ",
    "account.imageTooLargeError": "ទំហំរូបភាពធំពេក (អតិបរមា 3MB)",
    "account.notAnImageError": "សូមជ្រើសរើសឯកសាររូបភាព",
    "account.profileSaved": "បានកែប្រែប្រវត្តិរូបជោគជ័យ! ✨",
    "account.saveFailed": "មិនអាចរក្សាទុកបានទេ សូមព្យាយាមម្តងទៀត",
    ...
    "welcomePopup.body":
      "ចុះឈ្មោះឥឡូវនេះ ដើម្បីលេងហ្គេមជាមួយមិត្តភក្តិ ឡើងចំណាត់ថ្នាក់លើ Leaderboard និងទិញសម្លៀកបំពាក់ Avatar!",
    "welcomePopup.benefit1": "ទទួលពិន្ទុពីបេសកកម្ម & ការឈ្នះ 💎",
    "welcomePopup.benefit2": "ឡើងចំណាត់ថ្នាក់លើ Leaderboard 🏆",
    ...
    "notif.loginPrompt": "ចូលគណនីដើម្បីទទួលការអញ្ជើញលេងហ្គេម និងការជូនដំណឹង 💖",
    "notif.loginBtn": "ចូល / ចុះឈ្មោះ",
    "notif.empty": "គ្មានការជូនដំណឹងថ្មីទេ 🌈",
    "notif.promo": "🎁 ទទួលពិន្ទុពីបេសកកម្ម និងការឈ្នះហ្គេម!",
    ...
    "missions.title": "បេសកកម្មប្រចាំថ្ងៃ 🎯",
    "missions.claimBtn": "ទទួលរង្វាន់",
    "missions.claimed": "បានទទួល ✅",
    "missions.locked": "មិនទាន់រួច",
    "missions.claimSuccess": "ទទួលបានជោគជ័យ! ពិន្ទុត្រូវបានបញ្ចូល 🎉",
    "missions.claimError": "មិនអាចទទួលរង្វាន់បានទេ។",
    "missions.networkError": "បណ្ដាញមានបញ្ហា — សូមព្យាយាមម្ដងទៀត។",

    "shop.title": "ហាងតុបតែងតួអង្គ 🧢",
    "shop.buyBtn": "ទិញ",
    "shop.equipBtn": "ស្លៀកពាក់",
    "shop.unequipBtn": "ដោះ",
    "shop.equippedBadge": "កំពុងស្លៀកពាក់ ✅",
    "shop.notEnough": "ខ្វះពិន្ទុ",
    "shop.buySuccess": "ទិញជោគជ័យ! 🎉",
    "shop.buyError": "ទិញមិនបានទេ។",
    "shop.networkError": "បណ្ដាញមានបញ្ហា — សូមព្យាយាមម្ដងទៀត។",
    "shop.categoryAll": "ទាំងអស់",
    "shop.categoryHat": "មួក",
    ...
    "home.railGuestLoyaltyDesc": "ចូលគណនីដើម្បីតាមដានពិន្ទុ Arcade ដោះសោកម្រិត និងទិញសម្លៀកបំពាក់ Avatar។",
